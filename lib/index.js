...
exports.RENDERERS_MAP = exports.USA = void 0;
var React = __importStar(require("react"));
var STATES_LIST_1 = require("./STATES_LIST");
var CreateMapFn = function (_a) {
    var HOC = _a.HOC, _framesStroke = _a.framesStroke, _framesStrokeWidth = _a.framesStrokeWidth, getSVGProps = _a.getSVGProps;
    return function (key) {
        var Renderer = exports.RENDERERS_MAP[key];
        var svg_props = getSVGProps != null ? getSVGProps(key) : {};
        if (!Renderer)
            return null;
        if (HOC) {
            return (React.createElement(HOC, { renderer: Renderer, svg_props: svg_props, key: key, abbr: key }));
        }
        return React.createElement(Renderer, { svg_props: svg_props, key: key });
    };
};
var defaultFramesStroke = "#999";
var defaultFramesStrokeWidth = 2;
function USA(props) {
    ...
    var framesStrokeWidth = _framesStrokeWidth || defaultFramesStrokeWidth;
    return (React.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 959 593" }, SVGFilters === null || SVGFilters === void 0 ? void 0 :
        SVGFilters.map(function (SVGFilterComponent, key) { return (React.createElement(SVGFilterComponent, { key: key })); }),
        Object.keys(STATES_LIST_1.STATES_LIST)
            .filter(function (abbr) { return abbr !== "DC"; })
            .map(CreateMapFn({
            SVGFilters: SVGFilters,
            HOC: HOC,
            framesStroke: framesStroke,
            framesStrokeWidth: framesStrokeWidth,
...
exports.RENDERERS_MAP = {
    ...
    KS: function (_a) {
        var svg_props = _a.svg_props;
        return (React.createElement("path", __assign({}, svg_props, { id: "KS", d: "M485.9 259.5l-43.8-.6-40.6-1.2-21.7-.9-4.3 64.8 24.3 1 44.7 2.1 46.3.6 12.6-.3.7-35-1.2-11.1-2.5-2-2.4-3-2.3-3.6.6-3 1.7-1.4v-2.1l-.8-.7-2.6-.2-3.5-3.4z" })));
    },
    KY: function (_a) {
        var svg_props = _a.svg_props;
    ...
    NC: function (_a) {
        var svg_props = _a.svg_props;
        return (React.createElement("path", __assign({}, svg_props, { id: "NC", d: "M786.7 357.7L774 350l-3.1-.8-16.6 2.1-1.6-3-2.8-2.2-16.7.5-7.4.9-9.2 4.5-6.8 2.7-6.5 1.2-13.4 1.4.1-4.1 1.7-1.3 2.7-.7.7-3.8 3.9-2.5 3.9-1.5 4.5-3.7 4.4-2.3.7-3.2 4.1-3.8.7 1 2.5.2 2.4-3.6 1.7-.4 2.6.3 1.8-4 2.5-2.4.5-1.8.1-3.5 4.4.1 38.5-5.6 57.5-12.3 2 4.8 3.6 6.5 2.4 2.4.6 2.3-2.4.2.8.6-.3 4.2-2.6 1.3-.6 2.1-1.3 2.9-3.7 1.6-2.4-.3-1.5-.2-1.6-1.3.3 1.3v1h1.9l.8 1.3-1.9 6.3h4.2l.6 1.6 2.3-2.3 1.3-.5-1.9 3.6-3.1 4.8H828l-1.1-.5-2.7.6-5.2 2.4-6.5 5.3-3.4 4.7-1.9 6.5-.5 2.4-4.7.5-5.1 1.5zm49.3-26.2l2.6-2.5 3.2-2.6 1.5-.6.2-2-.6-6.1-1.5-2.3-.6-1.9.7-.2 2.7 5.5.4 4.4-.2 3.4-3.4 1.5-2.8 2.4-1.1 1.2z" })));
    },
    ND: function (_a) {
        var svg_props = _a.svg_props;
        return (React.createElement("path", __assign({}, svg_props, { id: "ND", d: "M471 126.4l-.4-6.2-1.8-7.3-1.8-13.61-.5-9.7-1.9-3.18-1.6-5.32V70.68l.6-3.85-1.8-5.54-28.6-.59-18.6-.6-26.5-1.3-25.2-2.16-.9 14.42-4.7 50.94 56.8 3.9 56.9 1.7z" })));
    },
    NE: function (_a) {
        var svg_props = _a.svg_props;
        return (React.createElement("path", __assign({}, svg_props, { id: "NE", d: "M470.3 204.3l-1-2.3-.5-1.6-2.9-1.6-4.8-1.5-2.2-1.2-2.6.1-3.7.4-4.2 1.2-6-4.1-2.2-2-10.7.6-41.5-2.4-35.6-2.2-4.3 43.7 33.1 3.3-1.4 21.1 21.7 1 40.6 1.2 43.8.6h4.5l-2.2-3-2.6-3.9.1-2.3-1.4-2.7-1.9-5.2-.4-6.7-1.4-4.1-.5-5-2.3-3.7-1-4.7-2.8-7.9-1-5.3z" })));
    },
    NH: function (_a) {
        var svg_props = _a.svg_props;
        return (React.createElement("path", __assign({}, svg_props, { id: "NH", d: "M881.7 141.3l1.1-3.2-2.7-1.2-.5-3.1-4.1-1.1-.3-3-11.7-37.48-.7.08-.6 1.6-.6-.5-1-1-1.5 1.9-.2 2.29.5 8.41 1.9 2.8v4.3l-3.9 4.8-2.4.9v.7l1.1 1.9v8.6l-.8 9.2-.2 4.7 1 1.4-.2 4.7-.5 1.5 1 1.1 5.1-1.2 13.8-3.5 1.7-2.9 4-1.9z" })));
    },
    NJ: function (_a) {
        var svg_props = _a.svg_props;
        return (React.createElement("path", __assign({}, svg_props, { id: "NJ", d: "M823.7 228.3l.1-1.5 2.7-1.3 1.7-2.8 1.7-2.4 3.3-3.2v-1.2l-6.1-4.1-1-2.7-2.7-.3-.1-.9-.7-2.2 2.2-1.1.2-2.9-1.3-1.3.2-1.2 1.9-3.1V193l2.5-3.1 5.6 2.5 6.4 1.9 2.5 1.2.1 1.8-.5 2.7.4 4.5-2.1 1.9-1.1 1 .5.5 2.7-.3 1.1-.8 1.6 3.4.2 9.4.6 1.1-1.1 5.5-3.1 6.5-2.7 4-.8 4.8-2.1 2.4h-.8l-.3-2.7.8-1-.2-1.5-4-.6-4.8-2.3-3.2-2.9-1-2z" })));
    },
    NM: function (_a) {
        var svg_props = _a.svg_props;
        return (React.createElement("path", __assign({}, svg_props, { id: "NM", d: "M270.2 429.4l-16.7-2.6-1.2 9.6-15.8-2 6-39.7 7-53.2 4.4-30.9 34 3.9 37.4 4.4 32 2.8-.3 10.8-1.4-.1-7.4 97.7-28.4-1.8-38.1-3.7.7 6.3z" })));
    },
    NV: function (_a) {
        var svg_props = _a.svg_props;
        return (React.createElement("path", __assign({}, svg_props, { id: "NV", d: "M123.1 173.6l38.7 8.5 26 5.2-10.6 53.1-5.4 29.8-3.3 15.5-2.1 11.1-2.6 16.4-1.7 3.1-1.6-.1-1.2-2.6-2.8-.5-1.3-1.1-1.8.1-.9.8-1.8 1.3-.3 7.3-.3 1.5-.5 12.4-1.1 1.8-16.7-25.5-42.1-62.1-12.43-19 8.55-32.6 8.01-31.3z" })));
    },
    NY: function (_a) {
        var svg_props = _a.svg_props;
        return (React.createElement("path", __assign({}, svg_props, { id: "NY", d: "M843.4 200l.5-2.7-.2-2.4-3-1.5-6.5-2-6-2.6-.6-.4-2.7-.3-2-1.5-2.1-5.9-3.3-.5-2.4-2.4-38.4 8.1-31.6 6-.5-6.5 1.6-1.2 1.3-1.1 1-1.6 1.8-1.1 1.9-1.8.5-1.6 2.1-2.7 1.1-1-.2-1-1.3-3.1-1.8-.2-1.9-6.1 2.9-1.8 4.4-1.5 4-1.3 3.2-.5 6.3-.2 1.9 1.3 1.6.2 2.1-1.3 2.6-1.1 5.2-.5 2.1-1.8 1.8-3.2 1.6-1.9h2.1l1.9-1.1.2-2.3-1.5-2.1-.3-1.5 1.1-2.1v-1.5h-1.8l-1.8-.8-.8-1.1-.2-2.6 5.8-5.5.6-.8 1.5-2.9 2.9-4.5 2.7-3.7 2.1-2.4 2.4-1.8 3.1-1.2 5.5-1.3 3.2.2 4.5-1.5 7.4-2.2.7 4.9 2.4 6.5.8 5-1 4.2 2.6 4.5.8 2-.9 3.2 3.7 1.7 2.7 10.2v5.8l-.6 10.9.8 5.4.7 3.6 1.5 7.3v8.1l-1.1 2.3 2.1 2.7.5.9-1.9 1.8.3 1.3 1.3-.3 1.5-1.3 2.3-2.6 1.1-.6 1.6.6 2.3.2 7.9-3.9 2.9-2.7 1.3-1.5 4.2 1.6-3.4 3.6-3.9 2.9-7.1 5.3-2.6 1-5.8 1.9-4 1.1-1-.4z" })));
    },
    OH: function (_a) {
        var svg_props = _a.svg_props;
        return (React.createElement("path", __assign({}, svg_props, { id: "OH", d: "M663.8 211.2l1.7 15.5 4.8 41.1 3.9-.2 2.3-.8 3.6 1.8 1.7 4.2 5.4.1 1.8 2h1.7l2.4-1.4 3.1.5 1.5 1.3 1.8-2 2.3-1.4 2.4-.4.6 2.7 1.6 1 2.6 2 .8.2 2-.1 1.2-.6v-2.1l1.7-1.5.1-4.8 1.1-4.2 1.9-1.3 1 .7 1 1.1.7.2.4-.4-.9-2.7v-2.2l1.1-1.4 2.5-3.6 1.3-1.5 2.2.5 2.1-1.5 3-3.3 2.2-3.7.2-5.4.5-5V230l-1.2-3.2 1.2-1.8 1.3-1.2-.6-2.8-4.3-25.6-6.2 3.7-3.9 2.3-3.4 3.7-4 3.9-3.2.8-2.9.5-5.5 2.6-2.1.2-3.4-3.1-5.2.6-2.6-1.5-2.2-1.3z" })));
    },
    OK: function (_a) {
        var svg_props = _a.svg_props;
    ...
    WY: function (_a) {
        var svg_props = _a.svg_props;
        return (React.createElement("path", __assign({}, svg_props, { id: "WY", d: "M353 161.9l-1.5 25.4-4.4 44-2.7-.3-83.3-9.1-27.9-3 2-12 6.9-41 3.8-24.2 1.3-11.2 48.2 7 59.1 6.5z" })));
    },
};
__exportStar(require("./us_states"), exports);
